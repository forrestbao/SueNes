...
class CnnProcessor(DataProcessor):
  """Processor for the MRPC data set (GLUE version)."""
  def __init__(self):
    self.f_train = 'cnn_dailymail_cross_train3.tsv'
    self.f_test = 'cnn_dailymail_cross_test3.tsv'
...
def main(_):
  ...
  from data_processors import Cnn30kProcessor
  from data_processors import CnnMutationProcessor
  from data_processors import CnnMutationDelProcessor
  from data_processors import CnnMutationRepProcessor
  ...
  processors = {
      ...
      "xnli": XnliProcessor,
      "cnndm": CnnProcessor,
      "cnndm30k": Cnn30kProcessor,
      "cnndm-mu-add": CnnMutationProcessor,
      "cnndm-mu-delete": CnnMutationDelProcessor,
      "cnndm-mu-replace": CnnMutationRepProcessor
  }
